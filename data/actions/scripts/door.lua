...
elseif item.itemid == 12065 then
if item.actionid == 0 then
doTransformItem(item.uid,12066)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12066 then
doTransformItem(item.uid,12065)
...
elseif item.itemid == 10774 then
if item.actionid == 0 then
doTransformItem(item.uid,10776)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 10776 then
doTransformItem(item.uid,10774)
...
elseif item.itemid == 12215 then
if item.actionid == 0 then
doTransformItem(item.uid,12216)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12216 then
doTransformItem(item.uid,12215)

elseif item.itemid == 12311 then
if item.actionid == 0 then
doTransformItem(item.uid,12312)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12312 then
doTransformItem(item.uid,12311)


elseif item.itemid == 12150 then
if item.actionid == 0 then
doTransformItem(item.uid,12151)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12151 then
doTransformItem(item.uid,12150)

elseif item.itemid == 12159 then
if item.actionid == 0 then
doTransformItem(item.uid,12160)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12160 then
doTransformItem(item.uid,12159)

elseif item.itemid == 12054 then
if item.actionid == 0 then
doTransformItem(item.uid,12055)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12055 then
doTransformItem(item.uid,12054)

elseif item.itemid == 12061 then
if item.actionid == 0 then
doTransformItem(item.uid,12062)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 12062 then
doTransformItem(item.uid,12061)
