...
function onCreatureSay(cid, type, msg)
	...
	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hiho ' .. getCreatureName(cid) .. ' Yo le puedo dar el Wayfarer addon 2, para mas informacion. diga help...')
  		focus = cid
  		talk_start = os.clock()
	...
	if msgcontains(msg, 'help') then
			selfSay('Para saber  que necesita para obtener el Wayfarer addon 2 diga: addon 2')
	...
	elseif msgcontains(msg, 'yes') and addon_state == 2 then
			...
			selfSay('Listo wn, ahora teni un nuevo addon gil qliao el addon 2 del wayfarer!.')
